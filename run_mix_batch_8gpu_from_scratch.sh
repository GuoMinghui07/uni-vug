...
singularity exec -e $image bash << EOF
    ...
    WANDB_EXP_NAME="dit_stage2_mixed_8gpu_resume_latest_continue-progress"
    CKPT_DIR="/scratch/e1539128/ckpt-8gpu-new/dit_training/checkpoints"
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun \
      ...
      --results-dir /scratch/e1539128/ckpt-8gpu-new \
      --precision bf16 \
